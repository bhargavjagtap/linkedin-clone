...
function HeaderLink({Icon, text, avatar, feed, active, hidden}) {
  ...
  <div
    ...
    } cursor-pointer flex flex-col justify-center items-center ${feed? "text-black/60 hover:text-white dark:text-white/75 dark:hover:text-white lg:-mb-1.5 space-y-1" : "text-gray-500 hover:text-gray-700"  
